...
#### 🇯🇵 일본: "이카가 데시타카(いかがでしたか)?" 블로그
일본 웹 생태계도 마찬가지였습니다. 검색 결과 상단을 점령한 소위 트렌드 블로그들이 사회적 문제가 되었습니다.
자극적인 제목("OOO의 연봉 공개! 결혼 상대는?")으로 클릭을 유도하지만, 내용은 인사말과 광고뿐입니다. 그리고 마지막은 항상 이 문구로 끝납니다.
![いかがでしたか 검색 피해 - https://note.com/pand_panda/n/n9d89609a68ca](/posts/deepDive/seo-chronicle-1-history/いかかでしたか.webp)
> **"조사해 보았지만 알 수 없었습니다! 어떠셨나요?(いかがでしたか？)"**
...
이제 SEO의 중심축은 '검색 순위' 그 자체에서 웹사이트가 제공하는 사용자 경험(User Experience)과 기술적 완성도로 옮겨가고 있습니다. 이것이 바로 현대의 SEO가 마케팅 영역을 넘어 프론트엔드 개발의 영역과 밀접해진 이유라고 생각합니다.
다음 2부에서는 이러한 흐름 속에서 개발자가 구체적으로 어떤 역할을 해야하는지 Core Web Vitals와 구조화된 데이터를 중심으로 이야기를 이어가겠습니다.
