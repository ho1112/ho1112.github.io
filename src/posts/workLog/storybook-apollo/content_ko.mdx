...
얼마 전 회사에서 사용하고 있던 Storybook이 어느 순간부터 제대로 작동하지 않는 상태가 되어 있었습니다.
...
기존의 구버전 Storybook이 최신 환경과의 호환성 문제로 인해 제대로 동작하지 않았기 때문에 아예 완전히 삭제하고 최신 버전의 Storybook을 새롭게 설치했습니다.
