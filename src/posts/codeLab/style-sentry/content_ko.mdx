...
팀 프로젝트에서 CSS 파일이 점점 커지면서 미사용 클래스들이 쌓이고, 디자인 시스템을 무시한 임의의 색상들이 사용되는 문제를 자주 겪었습니다. 매번 수동으로 확인하기엔 시간이 부족했고, 코드 리뷰에서도 놓치는 경우가 많았죠.

그래서 **"CSS 코드 품질을 자동으로 검증하는 도구"**를 만들어보기로 했습니다. 단순한 린터가 아닌, 팀의 코딩 스탠다드를 강제할 수 있는 도구를 목표로 했습니다.
...
### **정량적 성과**
- **처리 속도**: 1000개 파일 기준 평균 3초 내 분석 완료
- **정확도**: 동적 클래스 접근 패턴 95% 이상 정확 감지
- **지원 범위**: CSS, SCSS, Less, JSX, TSX 파일 완벽 지원

### **정성적 성과**
- **팀 피드백**: "코드 리뷰 시간이 30% 단축됐어요"
- **코드 품질**: 미사용 CSS 클래스 200+ 개 자동 발견 및 정리
- **일관성**: 디자인 시스템 색상 사용률 100% 달성

### **기술적 성과**
- **VSCode 마켓플레이스 등록** - 실제 사용자들이 설치하여 사용
- **오픈소스화** - GitHub에서 100+ 스타 받음
...
- **오탐**: 실제 사용되는 클래스가 미사용으로 표시될 수 있음

### **아쉬운 점과 개선 방향**
- **CSS-in-JS 미지원**: styled-components 같은 라이브러리 지원 필요
- **성능 최적화**: 대용량 프로젝트에서의 메모리 사용량 개선
- **설정 UI**: VSCode에서 더 직관적인 설정 인터페이스 제공

### **다음 프로젝트에 적용할 점**
- **사용자 중심 설계**: 기술적 완성도보다 실제 사용성 우선
- **점진적 개선**: MVP부터 시작해서 피드백을 받으며 개선
- **문서화의 중요성**: 사용법과 설정 방법을 명확히 문서화
- **제한사항 명시**: 완벽하지 않음을 인정하고 사용자에게 명확한 한계 안내

---

**결론**: 이 프로젝트를 통해 단순한 도구 개발을 넘어서 **개발자 경험을 개선하는 솔루션**을 만드는 방법을 배웠습니다. v1.0부터 v1.3까지의 진화 과정에서 얻은 인사이트들이 다음 프로젝트의 밑거름이 되고 있습니다.
