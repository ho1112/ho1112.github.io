      ...
      <section className="mb-10">
            ...
            items={[
              {
                challenge: (
                  <>
                    <strong>
                      {language === 'ko'
                        ? '대규모 아키텍처 정비 및 기술 부채 해소'
                        : '大規模アーキテクチャ整備および技術負債の解消'}
                    </strong>
                    <br />
                    {language === 'ko'
              ...
              },
              {
                challenge: (
                  <>
                    <strong>
                      {language === 'ko'
                        ? '성능 최적화 및 DX(개발자 경험) 향상'
                        : 'パフォーマンス最適化およびDX(開発者体験)向上'}
                    </strong>
                    <br />
                    {language === 'ko'
        ...
        <div className="mb-12">
          ...
          <ul className="mt-3 list-disc list-inside text-sm text-muted-foreground space-y-1">
            <li>
              {t(
                "output: 'export'로 정적 빌드하여 CDN 서빙 구조를 채택",
                "output: 'export'で静的ビルドし、CDNサーブ構成を採用",
              )}
            </li>
            <li>
              {t(
                '일본-한국 팀 간 기술 연동 및 커뮤니케이션 브리지 역할을 수행',
            ...
            items={[
              {
                challenge: (
                  <>
                    <strong>
                      {language === 'ko'
                        ? 'Web Components 글로벌 네비게이션'
                        : 'Web Componentsグローバルナビゲーション'}
                    </strong>
                    <br />
                    {language === 'ko'
        ...
        <div className="mb-12">
          ...
          <p className="mt-1 text-xs text-muted-foreground">PM:1, Engineer:3</p>
          <ul className="mt-3 list-disc list-inside text-sm text-muted-foreground space-y-1">
            <li>
              {t(
                '레거시 코드 리팩토링 및 서비스 리뉴얼 대응',
        ...
        <div className="mb-12 rounded border border-border/50 p-5">
          ...
          <div className="mb-6">
            <h4 className="text-sm font-semibold">
              {t(
                '도쿄증권거래소(東証) 주식 투자 정보 검색 서비스（2020/01〜2020/11）',
            ...
            <ul className="mt-2 list-disc list-inside text-sm text-muted-foreground space-y-1">
              <li>
                {t(
                  '메인 SE로 참가, 기술 스택 설계, 환경 구축 및 데모 버전 개발',
                  'メインSEとして参加、技術スタック設計、環境構築、デモバージョン開発',
                )}
              </li>
              <li>
                {t(
                  '주식 종목 검색, 기간별 분석 결과 및 클라이언트 화면 기능 개발',
          ...
          <div>
            <h4 className="text-sm font-semibold">
              {t(
                'KONAMI 물류・재고관리 시스템（2019/08〜2019/12）',
            ...
            <ul className="mt-2 list-disc list-inside text-sm text-muted-foreground space-y-1">
              <li>
                {t(
                  '소비세 증세(8%→10%) 대응 기반 시스템 수정',
                  '消費税増税（8%→10%）に対応して基盤システム修正',
                )}
              </li>
              <li>
                {t(
                  '품목·종별 재고관리, 집계 시스템, CSV/Excel 출력 기능 개발',
        ...
        <div className="mb-10 rounded border border-border/50 p-5">
          ...
          <div className="mb-6">
            <h4 className="text-sm font-semibold">
              {t(
                '図研 전기 제어·하네스 설계 소프트웨어（2019/01〜2019/06）',
            ...
            <ul className="mt-2 list-disc list-inside text-sm text-muted-foreground space-y-1">
              ...
              <li>
                {t(
                  '복수의 서버 시스템(Java, C#) 연동 및 다양한 버전의 네이티브 시스템 대응 개발',
                  '複数のサーバーサイドシステムを連携して開発（Java, C#）、違うバージョンのネイティブシステムに対応',
                )}
              </li>
              <li>
                {t(
                  '고객별 버전 커스터마이징 및 해외 문의 대응',
          ...
          <div className="mb-6">
            ...
            <ul className="mt-2 list-disc list-inside text-sm text-muted-foreground space-y-1">
              <li>
                {t(
                  '사내 부품 등록·검색 화면 개발 및 테스트 케이스 작성',
          ...
          <div>
            <h4 className="text-sm font-semibold">
              {t(
                '第一生命 보험 서비스 간 통합 인증 시스템 SSO（2018/04〜2018/08）',
        ...
        <table className="w-full border-collapse text-sm">
          ...
          <tbody>
            {[
              ...
              {
                category: 'DB',
                name: 'PostgreSQL, MongoDB, Oracle, Supabase',
                years: '',
                rowSpan: 1,
              },
              {
                category: t('인프라・도구', 'インフラ・ツール'),
                name: 'Docker, GCP, Git, GitHub Actions, Bun, Figma, Storybook',
                years: '',
                rowSpan: 1,
              },
            ].map((row, i) => (
              <tr key={i}>
                ...
                <td className="border border-border/60 px-3 py-2 text-muted-foreground">
                  {row.name}
                </td>
                <td className="border border-border/60 px-3 py-2 text-muted-foreground whitespace-nowrap">
                  {row.years}
                </td>
              </tr>
            ))}
