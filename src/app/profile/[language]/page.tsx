                ...
                <ul className="text-muted-foreground mb-4 list-disc list-inside space-y-1">
                  {(language === 'ko'
                    ? [
                        ...
                        '기업-학생 면접 일정조정 기능 설계/구현: 기업이 타이틀·메모·날짜·시간·정원·오프라인 주소/온라인 URL/비밀번호를 등록해 학생에게 제안하고, 학생은 가능한 일시 선택 또는 불가 응답을 반환해 기업이 즉시 재편집할 수 있는 플로우',
                    ...
                    : [
                        ...
                        '企業と学生の面接日程調整機能を設計/実装：企業がタイトル・メモ・日付・時間・定員・オフライン会場/オンラインURL・パスワードを登録して学生に提案し、学生は参加可能枠の選択または不可返信を行い、企業が即座に再編集できるフロー',
