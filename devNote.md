...
## 📊 현재 프로젝트 상태 (2025-08-26 22:00 기준)
...
**목표**: 실제 API 연동 및 댓글 시스템 완성  
**우선순위**:

1. TanStack Query 설치 및 설정
2. 댓글 API 엔드포인트 구현
3. Mock 데이터를 실제 API 호출로 교체
4. 댓글 작성 후 자동 새로고침 구현
5. 에러 처리 및 사용자 피드백 UI 추가

---

_마지막 업데이트: 2025-08-26 22:00 (1단계 댓글 컴포넌트 목업 개발 완료)_
